...
- [ ] **remaining-tasks.md 更新** — module update、LOW issues 已完成但文件未標記 done（來自 thread 1775069650）
...
- [ ] **opentree init 加入 admin_users 必填設定** — onboard 流程中一併設定管理者（來自 thread 1775069650）
